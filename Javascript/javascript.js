...
function myFunction() {
	...
	document.getElementById("qr-codeTxt").innerHTML= "Benutzer: " + document.getElementById('qr-data').value +" "+ document.getElementById('connecting').value 
	...
	function bestCaseSupramatic(){
		...
		document.getElementById("qr-codeTxt").innerHTML="Favorit: Supramatic"
	...
	function bestCaseSupramatic4V2(){
		...
		var qrCode = new QRCode(document.getElementById('qr-code'));
		var qrCodeFav = document.getElementById('qr-code');
		document.getElementById("qr-codeTxt").innerHTML="Favorit: Supramatic4V2"
	...
	function bestCaseRollmatic2(){
		var qrCode = new QRCode(document.getElementById('qr-code'));
		var qrCodeFav = document.getElementById('qr-code');
		document.getElementById("qr-codeTxt").innerHTML="Favorit: Rollmatic"
